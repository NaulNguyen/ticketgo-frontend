...
const Footer = () => {
    return (
        <Box
            ...
            <Typography
                variant="body2"
                sx={{ color: "black", marginBottom: "10px", fontWeight: "700", fontSize: "16px" }}>
                Công ty TNHH Thương Mại Dịch Vụ TicketGo
            </Typography>
            <Typography variant="body2" sx={{ color: "gray", marginBottom: "10px" }}>
                Địa chỉ đăng ký kinh doanh: 8C Chữ Đồng Tử, Phường 7, Quận Tân Bình, Thành Phố Hồ
                Chí Minh, Việt Nam
            </Typography>
            <Typography variant="body2" sx={{ color: "gray", marginBottom: "10px" }}>
