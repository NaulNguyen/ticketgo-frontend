  ...
  return (
    <header className="flex justify-between items-center px-6 py-4 bg-white shadow-md">
      ...
      <div className="flex space-x-4">
        ...
        <Button variant="contained" color="primary" startIcon={<LoginIcon />} onClick={handleOpenLoginModal}>
          Đăng nhập
        </Button>
      </div>
      ...
      >
        ...
        >
          <Registration onClose={handleCloseRegisterModal} onLoginClick={handleOpenLoginModal} />
        </Box>
      </Modal>
      ...
      >
        ...
        >
          <Login onClose={handleCloseLoginModal} onRegisterClick={handleOpenRegisterModal} />
        </Box>
      </Modal>
    </header>
  );
